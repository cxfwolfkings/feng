        ...
        fill: function () {
            ...
            while (prevMonth.valueOf() < nextMonth) {
                ...
                if (weekDay === this.o.weekStart) {
                    ...
                    // modify by Colin start
                    
                    // modify by Colin stop
        ...
        click: function (e) {
            ...
            if (!target.hasClass('disabled')) {
                if (target.hasClass('day')) {
                    ...
                    if (target.hasClass('holiday')) {
                        target.removeClass('holiday');
                        day = Number(target.text());
                        year = this.viewDate.getUTCFullYear();
                        month = this.viewDate.getUTCMonth();
                        if (window.holidays) {
                            var elemIndex = holidays.indexOf(year + "-" + (month + 1) + "-" + day);
                            if (elemIndex >= 0) {
                                holidays.splice(elemIndex, 1);
                            }
                        }
                    } else {
                        ...
                        month = this.viewDate.getUTCMonth();
                        if (window.holidays) {
                            holidays.push(year + "-" + (month + 1) + "-" + day);
                        }
                    }
                }
            }
